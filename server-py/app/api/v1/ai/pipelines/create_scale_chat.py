...
async def chat_create_scale(
    ...
    *,
    ...
    return await call_llm_for_pipeline(
        db, org_id=org_id, user_id=user_id, pipeline="create-scale-chat", stub_result=stub
    )


__all__ = ["chat_create_scale"]
