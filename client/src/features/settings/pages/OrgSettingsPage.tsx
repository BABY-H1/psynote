...
import { isVisible, type SceneContext, type SceneVisibility } from '../../../app/scene/visibility';
...
interface TabDef extends SceneVisibility {
  key: SettingsTab;
  label: string;
...
// Admin-level tabs reuse the `soloAsAdmin: true` quirk because a solo user
// IS the org — they should see "admin" tabs like "基本信息" / "公开服务" even
// though their role is nominally `org_admin` of a 1-person org.
...
const TABS: TabDef[] = [
  ...
  // 咨询师档案仅对 counselor / org_admin 可见
...
// Group render order — "我的" first, then org-level groups.
const GROUP_ORDER = ['me', 'facade', 'org', 'business', 'security'] as const;
