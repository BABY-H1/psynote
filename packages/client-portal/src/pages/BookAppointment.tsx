...
export function BookAppointment() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <h2 className="text-xl font-bold text-slate-900">预约咨询</h2>

      {/* Progress steps */}
      <div className="flex items-center gap-2 text-sm">
        {[
          { key: 'counselor', label: '选择咨询师' },
      ...
      {step === 'done' && (
        <div className="bg-white rounded-xl border border-slate-200 p-8 text-center">
          ...
          <h3 className="text-lg font-bold text-slate-900 mb-2">预约请求已提交</h3>
          ...
          <div className="flex gap-3 justify-center">
            <button
              ...
              className="px-6 py-2 bg-brand-600 text-white rounded-lg text-sm font-medium hover:bg-brand-500"
            >
              查看我的预约
            </button>
            <button
    ...
    <div className="grid gap-3 md:grid-cols-2">
      {counselors.map((c) => (
        <button
          ...
          className="bg-white rounded-xl border border-slate-200 p-5 text-left hover:border-brand-500 hover:bg-brand-50 transition"
        >
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-6 space-y-5">
      <div className="text-sm text-slate-500">
        咨询师: <span className="font-medium text-slate-900">{counselorName}</span>
      </div>
